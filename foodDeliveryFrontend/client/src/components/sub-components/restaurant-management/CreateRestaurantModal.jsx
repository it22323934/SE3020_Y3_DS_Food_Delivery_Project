...
export const CreateRestaurantModal = ({ show, onClose, onSuccess, token }) => {
    ...
    <Modal show={show} onClose={handleClose} size="6xl" popup={false}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <label
                      htmlFor="restaurantImage"
                      className="flex items-center justify-center px-3 py-1.5 bg-green-50 text-green-700 rounded-lg cursor-pointer hover:bg-green-100 w-full text-sm"
                    >
                      <HiPhotograph className="mr-1" size={16} />
                      {restaurantImage ? "Change Image" : "Upload Image"}
                    </label>
                      ...
                      >
                        <div className="col-span-3">
                          <span className="text-sm font-medium">
                            {
                              daysOfWeek.find((d) => d.value === day.dayOfWeek)
                                ?.label
                            }
                          </span>
                        </div>
      ...
      <Modal.Footer className="border-t border-gray-200 bg-gray-50 flex justify-between">
        ...
        <Button
          ...
          disabled={
            isSubmitting || restaurantImageUploading || bannerImageUploading
          }
