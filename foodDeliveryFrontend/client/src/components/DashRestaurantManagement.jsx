            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm font-medium uppercase text-gray-500">Total Restaurants</p>
                    <h5 className="text-3xl font-bold text-gray-800 dark:text-white">{totalRestaurants}</h5>
                  </div>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm font-medium uppercase text-gray-500">Active Restaurants</p>
                    <h5 className="text-3xl font-bold text-green-600">{activeRestaurants}</h5>
                  </div>
              ...
              <Card className="hover:shadow-lg transition-shadow duration-300">
                <div className="flex justify-between items-center">
                  <div>
                    <p className="text-sm font-medium uppercase text-gray-500">Inactive Restaurants</p>
                    <h5 className="text-3xl font-bold text-red-600">{inactiveRestaurants}</h5>
                  </div>
            ...
            <div className="overflow-x-auto">
              {filteredRestaurants.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-12">
                  ...
                  <h2 className="mt-2 text-xl font-semibold text-gray-700">No Restaurants Found</h2>
                  <p className="text-gray-500 mt-1">No restaurants match your current search criteria.</p>
                </div>
              )}
            </div>
            ...
            <Modal.Body>
              <div className="text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                  ...
                  <p className="mt-2 text-sm font-semibold text-gray-800">{selectedRestaurant?.name}</p>
                </h3>
