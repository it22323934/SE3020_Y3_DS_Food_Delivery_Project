...
export default function Checkout() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Here, you would normally make a real API call to submit the order
      // const response = await orderService.createOrder(order, currentUser?.token);
          ...
          <form onSubmit={handleSubmit}>
            ...
            <Card className="mb-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  <Label htmlFor="deliveryInstructions" value="Delivery Instructions (Optional)" />
                  <Textarea
            ...
            <Card className="mb-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center pl-4 border border-gray-200 rounded dark:border-gray-700">
                  ...
                  />
                  <Label htmlFor="paypal-payment" className="w-full py-4 ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    <div className="flex items-center">
                      PayPal
              ...
              {cart.discountAmount > 0 && (
                <div className="flex justify-between text-green-600 dark:text-green-400">
                  <span className="flex items-center">
                    ...
                    Discount {cart.appliedPromotion ? `(${cart.appliedPromotion.code})` : ""}
                  </span>
              ...
              <div className="mt-4 bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-800">
                <div className="flex items-center text-green-700 dark:text-green-400">
                  ...
                  <span className="font-medium">
                    Promo code <span className="font-bold">{cart.appliedPromotion.code}</span> applied
                  </span>
                </div>
