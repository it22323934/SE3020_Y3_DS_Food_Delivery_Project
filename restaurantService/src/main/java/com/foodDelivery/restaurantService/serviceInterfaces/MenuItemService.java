...
public interface MenuItemService {
    ...
    List<MenuItemResponse> getAvailableMenuItemsByRestaurantId(String restaurantId);
    List<MenuItemResponse> getAvailableMenuItemsByCategoryId(String categoryId);
}