...
Write-Host "Generating Security Reports for OrderService" -ForegroundColor Green
...
<html>
<head>
    <title>Security Report - OrderService</title>
    <style>
...
<body>
    <div class="header">
        <h1>🔒 Security Report - OrderService</h1>
    ...
    <div class="section">
        ...
        <ul>
            ...
            <li>Update Spring Boot, Jackson, and other critical dependencies</li>
