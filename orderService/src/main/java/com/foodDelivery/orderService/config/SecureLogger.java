 ...
 * sensitive data like passwords, tokens, or personal information.
 */
@Slf4j
@Component
public class SecureLogger {
    ...
    private static final Pattern TOKEN_PATTERN = Pattern.compile("(?i)(token|auth|jwt|bearer)\\s*[:=]\\s*[^\\s,}]+", Pattern.CASE_INSENSITIVE);
    ...
    /**
     * Logs business operations with sanitized data
     */
    public static void logBusinessOperation(String operation, String userId, Map<String, Object> data) {
        Map<String, Object> sanitizedData = sanitizeMap(data);
        log.info("BUSINESS_OPERATION: {} | User: {} | Data: {}", 
                operation, userId, sanitizedData);
    }

    /**
     * Logs database operations securely
     */
    public static void logDatabaseOperation(String operation, String table, String userId) {
        log.info("DB_OPERATION: {} | Table: {} | User: {}", operation, table, userId);
    }

    /**
     * Logs external service calls securely
     */
    public static void logExternalServiceCall(String service, String endpoint, String method, int statusCode) {
        log.info("EXTERNAL_SERVICE: {} | Endpoint: {} | Method: {} | Status: {}", 
