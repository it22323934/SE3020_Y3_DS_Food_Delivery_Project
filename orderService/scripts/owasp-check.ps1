# OWASP Dependency Check Script for OrderService (PowerShell)
# This script runs OWASP dependency check and generates security reports

Write-Host "🔒 Starting OWASP Dependency Check for OrderService..." -ForegroundColor Green

# Change to the orderService directory
